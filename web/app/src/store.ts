...
import { THEME_KEY, applyDark, readStoredTheme, resolveDark, watchSystemTheme, type ThemeMode } from '../../shared/theme'
...
export function connectWS() {
  ...
  function connect() {
    ...
    // 包内注册的 /api/ws 对外是 /debug/api/ws —— 与共享层 /api/* 的同名路径靠它区分。
